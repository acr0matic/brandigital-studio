  ...
  <div class="side-menu__container">
    <div class="side-menu__wrapper">
      <div class="side-menu__action">
        <div class="side-menu__close hamburger-custom hamburger-custom--right">
          <div><span></span></div>
        </div>
        <!-- /.side-menu__close -->
      </div>
      ...
      <div class="side-menu__social social">
        ...
        <a href="" class="side-menu__link social__link"><img src="img/icons/social/mail.svg" alt="" class="side-menu__icon social__icon"></a>
        <a href="" class="side-menu__link social__link"><img src="img/icons/social/pinterest.svg" alt="" class="side-menu__icon social__icon"></a>
      </div>
      <!-- /.side-menu__social -->
    </div>
    <!-- /.side-menu__wrapper -->
