          ...
          <div class="service__card service-card" data-micromodal-trigger="modal-service">
            ...
            <div class="service-card__content">
              ...
              <ul class="list list--dotted">
                <li class="list__item">Внедрение форм для систем обратной связи</li>
                <li class="list__item">Анализ конкурентов и ниши бизнеса</li>
                <li class="list__item">Разработка продающей структуры, дизайн </li>
                <li class="list__item">Адаптивная верстка сайта, тестирование</li>
              </ul>
